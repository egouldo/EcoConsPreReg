...
*Describe any data preparation and processing steps, including manipulation of environmental layers, e.g. standardisatino and geographic projection.* Something about always retaining the raw data in a safe place, no manipulations to the raw file.
