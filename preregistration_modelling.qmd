...
authors: # Replace with authors in your study 
  ...
  - name: Hannah S. Fraser
    ...
    roles: [contributor, conceptualization, methodology, investigation, supervision, editing]
    affiliations:
      - ref: 1
    affil-id: 1
  - name: Henry Wootton
  ...
  - name: Megan K. Good
    ...
    roles: [contributor, methodology, editing]
    affiliations:
      - ref: 1
    affil-id: 1
  - name: David H. Duncan
    orcid: 0000-0003-4411-8214
    roles: [contributor, methodology]
    affiliations:
      - ref: 1
    affil-id: 1
  - name: Cindy E. Hauser
    orcid: 0000-0002-5187-6585
    roles: [contributor, methodology, investigation, editing]
    affiliations:
      - ref: 2
    affil-id: 2
  - name: Bonnie C. Wintle
    roles: [contributor, conceptualization, methodology, supervision, writing, editing]
...
abstract: |
  ...
  Replace author, author-affiliations and persistent ID's (e.g. [ORCID iD]( https://orcid.org/)), keywords, title and abstract [metadata in the document YAML](https://quarto.org/docs/journals/authors.html) as relevant to your study.
  
  For non-trivial modelling studies, especially where model parameter and structure is in any way data-contingent, we recommend taking an *[Adaptive Preregistration](https://egouldo.github.io/EcoConsPreReg/)* approach [@Gould2024a]. Please read the [*Primer on Adaptive Preregistration*](https://egouldo.github.io/EcoConsPreReg/adaptive_preregistration_background.html) before beginning.
  
  
  All preregistration items should be completed, excluding items marked as optional or in cases where they are not applicable to your study, which can be deleted. Additional preregistration items can be added as required at the researchers' discretion.
---


# Study Information {.unnumbered}

## CRediT Contribution Statement {.unnumbered}

::: callout-caution
## Preregistration Item

Identify potential contributions according to the CRediT taxonomy (<https://doi.org/10.1371/journal.pone.0244611.t001>) and write a [CRediT contribution statement](https://authorservices.wiley.com/author-resources/Journal-Authors/open-access/credit.html "See link for example statement.").
:::
...
-   [ ] Explain any real or perceived conflicts of interest with this study execution. For example, any interests or activities that might be seen as influencing the research (e.g., financial interests in a test or procedure, funding by companies for research).
:::
...
-   [ ] "We plan to make the data available (yes / no)," specify the planned data availability level from the following options:
    ...
    -   Data access via secure data centre (no download, usage/analysis only in a secure data centre)
...
-   [ ] "We plan to make the code available (yes / no)," specify the planned code availability level from the following options:
    ...
    -   Code access via secure code centre (no download, usage/analysis only in a secure code centre)
...
-   [ ] Select and respond to the relevant item below:
    -   If relevant institutional ethical approval for the study has been obtained, provide the relevant identifier, and link to relevant documents.
    -   If ethical approval has not yet been obtained, but is required, provide a brief overview of plans for obtaining study approval in accordance with established ethical guidelines.
    -   Alternatively, if the study is exempt from ethical approval, explain exemption.
:::
...
The scope of the model includes temporal and spatial resolutions, which should also be defined here [@Mahmoud2009]. Any external limitations on model development, analysis and flexibility should also be outlined in this section [@Jakeman:2006ii].
:::
...
-   [ ] How will you operationalise any scenarios identified in @sec-analytical-objectives? For example, how will you operationalise any qualitative changes of interest, such as ‚ 'deterioration' or 'improvement'?
...
-   [ ] Data collection procedures - describe your data collection process, including how sites and transects or any other physical unit were selected and arranged. Describe any inclusion or exclusion rules, and the study timeline.
...
#### Describe any data exploration or preliminary data analyses {#sec-exploratory-analyses}

::: callout-note
## Explanation

In many modelling cases, it is necessary to perform preliminary analyses to understand the data and check that assumptions and requirements of the chosen modelling procedures are met. Data exploration prior to model fitting or development may include exploratory analyses to check for collinearity, spatial and temporal coverage, quality and resolution, outliers, or the need for transformations [@Yates2018].
:::

::: callout-warning
## Caution! Beware questionable research practices and overfitting

Any modelling and analysis decisions based on data exploration or preliminary investigations increase the risk of questionable research practices and overfitting [@Gould2026]. Such *data-dependent* analytic decisions [@Liu2020] should ideally be performed using a small, independent subset of the full dataset in order to avoid model overfitting arising from "data leakage" or "model selection bias" [@Kapoor2023; @Campbell2021; @Arnqvist2020].

The preregistration item below follows a protocol for registering 'flexible' analyses, please see our ['Primer on Adaptive Preregistration'](https://egouldo.github.io/EcoConsPreReg/adaptive_preregistration_background.html) in Gould et al. -@Gould2024a for details.
:::
...
-   [ ] State what quantity or estimand needs to be known in order to proceed with further decision-making about the modelling procedure, stating why the analysis is necessary.
...
-   [ ] Specify exactly which parts of the data will be used, ensuring that any data subsets used are described in @sec-calibration-data.
...
-   [ ] Describe what modelling framework, approach or class of model you will use to implement your model and relate your choice to the model purpose and analytical objectives described in @sec-model-purpose-context-and-problem-context and @sec-analytical-objectives.
:::
...
#### Describe calibration/validation data {#sec-calibration-data}
...
-   [ ] Which data will be used as for the testing data? What method will be used for generating training / test data subsets?
...
*If performing any data exploration or other preliminary analyses (delete as needed)*

-   [ ] Describe any data subsets used for each analysis in *@sec-exploratory-analyses.*
:::
...
Uncertainty in models arises due to incomplete system understanding (which processes to include, or which interact), from imprecise, finite and sparse data measurements, and from uncertainty in input conditions and scenarios for model simulations or runs [@Jakeman:2006ii]. Non-technical uncertainties can also be introduced throughout the modelling process, such as uncertainties arising from issues in problem-framing, indeterminicies, and modeller / client values [@Jakeman:2006ii].
...
## References {.sectionbibliography}
