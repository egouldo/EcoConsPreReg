...
But not just a pre-registration template, we take into account the iterative nature of model development
...
Given this defining feature of the modelling process, it is critical that the design of the interface and procedure for implementing the preregistration inherently capture this iterative nature of development. We attempt to do this by...
...
Speak back to the the predefined use-cases, how does our proposed methodology and its template address the intended use-cases and purposes?
