...
**Abstract:** *Ecology is at risk of a 'reproducibility crisis', in particular, there are serious transparency problems in the reporting of ecological models, which is concerning because a lack of complete and transparent reporting practices provide the conditions in which questionable research practices are likely to arise, leading to irreproducible findings. Irreproducibility of model-based research threatens the progress of both scientific discovery in 'pure' research, and risks wrong or sub-optimal conservation and management decisions being implemented when models are used in decision-support. Preregistration is an open-science practice adopted in scientific disciplines that have confronted the reproducibility crisis, which aims to improve research transparency and mitigate questionable research practices. There has been little uptake of preregistration in ecology and conservation, and within disciplines wherein preregistration has been adopted and become common practice, many modellers and researchers engaged in non-hypothesis testing research have vehemently eschewed preregistration on the grounds that existing preregistration templates are irrelevant to their research because they are focussed on null-hypothesis significance testing. We took a user-centred design approach to the task of translating preregistration into model-based research contexts for ecology and conservation. Structured discussion and collaborative activities underpinned the development of a preregistration template that captures critical analysis decisions in the process of the model development cycle. The iterative nature of model development was identified as a key barrier to implementing preregistration for modelling research because it conflicts with the linear procedure of preregistration in which a researcher shifts from ideation to analysis planning, to analysis and then reporting. We propose a methodology for implementing 'adaptive preregistration' leveraging git and GitHub, which accommodates common practices in modelling where some analysis decisions are difficult or cannot be made in advance, where downstream decisions might be dependent on the outcome of earlier decisions, and where preliminary analyses might need to be conducted before proceeding with further modelling. We tested and evaluated the preregistration template and methodology using a case-study of environmental flows modelling for decision-support in Victoria, Australia. This research provides an extensible template and methodology for implementing adaptive preregistration of ecological models, to be used in either pure or applied settings. We hope that this research will facilitate wider uptake of preregistration in ecology and that our proposed methodology for implementing adaptive preregistration might be applied in model-based research within science more broadly. Modellers need no longer cry "but, I can't preregister my research."*

**Keywords** *(no more than 8 for MEE).***:** *preregistration, transparency, reproducibility, modelling, ecology, conservation, open-science, research software engineering.*
