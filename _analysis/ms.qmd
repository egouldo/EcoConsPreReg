...
![illustrates the evolution of model development across preregistration iterations in the case study. The two Registered Flexibility steps in the Main Analysis (v3) (shown in blue) are further described in Fig. 4.](images/Figure_3-Case_Study_Workflow.png){#fig-case-study-workflow width="14cm" height="24cm"}
