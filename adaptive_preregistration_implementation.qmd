...
For those with basic familiarity of git and GitHub, we take a git flow approach, using git branches and pull requests. If you are not yet familiar with these GitHub features, we have linked to the relevant GitHub documentation pages throughout for further details.
